...
#Note -  when a seat type is sole out-  means there is no seats in the seat type, but still the user can request for one and he can be offered waitlisted , right?
